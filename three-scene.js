...
(function () {
  ...
  const mat = new THREE.MeshPhongMaterial({
    color:    new THREE.Color(0.08, 0.18, 0.95),
    emissive: new THREE.Color(0.01, 0.04, 0.22),
    specular: new THREE.Color(0.8,  0.85, 1.0),
    shininess: 600,
    flatShading: false,
  });
  ...
  function animate() {
    ...
    pt1.position.set(-3 + Math.sin(t * 0.38) * 3,  5 + Math.cos(t * 0.30) * 2, 6);
    pt2.position.set( 2 + Math.cos(t * 0.44) * 2.5, 2 + Math.sin(t * 0.36) * 1.5, 7 + Math.sin(t * 0.28) * 1.5);
    pt3.position.set( 5 + Math.cos(t * 0.52) * 2,  -2 + Math.sin(t * 0.40) * 2, 4 + Math.cos(t * 0.33) * 2);
